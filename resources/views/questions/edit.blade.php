                    ...
                    <div class="panel-body">
                        ...
                        <form action="/questions/{{ $question->id }}" method="post">
                            ...
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="标题" value="{{ $question->title }}" required autofocus>
                                @if ($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <select name="topic[]" class="js-example-placeholder-multiple form-control js-data-example-ajax" multiple="multiple">
